...
class ContactView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            messages.error(request,"Cannot submit your query. Please make sure all fields are valid.")
            return render(
                request,
                    self.template_name,
                     {"form": form},
        ...
        if is_ajax == "XMLHttpRequest":
             ...
             if form.is_valid():
                 ...
                 return JsonResponse(
                     {
                         "success": False,
                         "message": "Cannnot suscribe to the newsletter.",
                     },
                     status=400,
                 )
        else:
